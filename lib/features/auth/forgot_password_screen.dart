...
// Step 2: Enter OTP (A123 format) + new password
...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  Future<void> _resetPassword() async {
    ...
    if (otp.isEmpty) {
      setState(() => _error = 'Enter the OTP from your email');
      return;
    }
    if (newPass.length < 8) {
  ...
  Widget _buildStep2() {
    return Column(
      ...
      children: [
        Text(
          'We sent a code to $_email. Enter it below along with your new password.',
        ...
        TextButton(
          ...
          child: const Text(
            'Resend code',
            style: TextStyle(color: AppColors.accent, fontFamily: 'Inter'),
          ),
        ),
      ],
    );
